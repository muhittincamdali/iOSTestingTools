...
<!-- TOC START -->
## Table of Contents
- [🧪 iOS Testing Tools](#-ios-testing-tools)
...
- [🧪 Unit Testing](#-unit-testing)
  - [Unit Test Manager](#unit-test-manager)
  - [Test Case Example](#test-case-example)
  - [Mocking Framework](#mocking-framework)
- [🖥️ UI Testing](#-ui-testing)
  - [UI Test Manager](#ui-test-manager)
  - [UI Test Case Example](#ui-test-case-example)
  - [Visual Testing](#visual-testing)
- [⚡ Performance Testing](#-performance-testing)
  - [Performance Test Manager](#performance-test-manager)
  - [Performance Test Case](#performance-test-case)
- [🤖 Test Automation](#-test-automation)
